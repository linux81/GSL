...
// definition of input parameters: prg_name nbr_rows nbr_colm nbr_alg seed file_name  
...
fprintf(stderr,"nazwa_programu liczba_wierszy liczba_kolumn numer_algorytmu_gsl seed nazwa_pliku_danych\n");
